    ...
    return (
      <div>
       <Form
        ...
        initialValues={{description:dataEdit.description,
            version:dataEdit.version,
            startDate: moment(new Date(dataEdit.startDate*1000),'YYYY-MM-DD'),
            releaseDate:moment(new Date(dataEdit.releaseDate*1000),'YYYY-MM-DD'),
